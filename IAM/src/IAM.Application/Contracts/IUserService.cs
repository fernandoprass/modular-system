...
public interface IUserService
{
   ...
   Task<Result<UserDto>> CreateUserAsync(UserCreateRequest request, bool customerExists);
   Task<Result> UpdateAsync(Guid id, UserUpdateRequest request);
   Task<Result> UpdatePasswordAsync(Guid id, UserUpdatePasswordRequest request);
